...
- Changes Exp 2's worker balance to 4P(TP2) and 4D(TP2) workers while retaining round-robin routing.
...
export EXP_DIR=/ephemeral/shared/qwen3-32b-fp8/vllm/03-disagg-routing-4p4d
export DEPLOYMENT=qwen3-32b-fp8-vllm-disagg-4p4d
export PERF_JOB=qwen3-32b-fp8-vllm-disagg-4p4d-perf
mkdir -p "$EXP_DIR"
```
...
metadata:
  name: qwen3-32b-fp8-vllm-disagg-4p4d
  labels:
    benchmark.nvidia.com/experiment: qwen3-32b-fp8-vllm-disagg-4p4d
spec:
...
kind: Job
metadata:
  name: qwen3-32b-fp8-vllm-disagg-4p4d-perf
spec:
  backoffLimit: 0
  completions: 1
  parallelism: 1
  ...
  template:
    metadata:
      labels:
        app: qwen3-32b-fp8-vllm-disagg-4p4d-perf
    spec:
      restartPolicy: Never
      tolerations:
      ...
      containers:
        - name: perf
          ...
          env:
            - name: EXPERIMENT_ID
              value: exp3-disagg-routing-4p4d
            - name: DEPLOYMENT_NAME
              value: qwen3-32b-fp8-vllm-disagg-4p4d
            - name: MODEL_NAME
              value: Qwen/Qwen3-32B-FP8
            - name: MODEL_REVISION
              value: aa55da1ecc13d006e8b8e4f54579b1ea8c3db2df
            - name: ENDPOINT
              value: qwen3-32b-fp8-vllm-disagg-4p4d-frontend:8000
            - name: AIPERF_VERSION
              value: "0.10.0"
