...
export EXP_DIR=/ephemeral/shared/qwen3-32b-fp8/vllm/02-disagg-routing
...
metadata:
  ...
  labels:
    benchmark.nvidia.com/experiment: qwen3-32b-fp8-vllm-disagg
spec:
    ...
    spec:
      ...
      containers:
        - name: perf
          ...
          env:
            - name: EXPERIMENT_ID
              value: exp2-disagg-routing
            - name: DEPLOYMENT_NAME
              value: qwen3-32b-fp8-vllm-disagg
            - name: MODEL_NAME
              value: Qwen/Qwen3-32B-FP8
            - name: MODEL_REVISION
