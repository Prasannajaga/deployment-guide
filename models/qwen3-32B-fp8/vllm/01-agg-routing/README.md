...
export EXP_DIR=/ephemeral/shared/qwen3-32b-fp8/vllm/01-agg-routing
export DEPLOYMENT=qwen3-32b-fp8-vllm-agg
export PERF_JOB=qwen3-32b-fp8-vllm-agg-perf
mkdir -p "$EXP_DIR"
```
...
metadata:
  name: qwen3-32b-fp8-vllm-agg
  labels:
    benchmark.nvidia.com/experiment: qwen3-32b-fp8-vllm-agg
spec:
...
kind: Job
metadata:
  name: qwen3-32b-fp8-vllm-agg-perf
spec:
  backoffLimit: 0
  completions: 1
  parallelism: 1
  ...
  template:
    metadata:
      labels:
        app: qwen3-32b-fp8-vllm-agg-perf
    spec:
      restartPolicy: Never
      tolerations:
      ...
      containers:
        - name: perf
          ...
          env:
            - name: EXPERIMENT_ID
              value: exp1-agg-round-robin
            - name: DEPLOYMENT_NAME
              value: qwen3-32b-fp8-vllm-agg
            - name: MODEL_NAME
              value: Qwen/Qwen3-32B-FP8
            - name: MODEL_REVISION
              value: aa55da1ecc13d006e8b8e4f54579b1ea8c3db2df
            - name: ENDPOINT
              value: qwen3-32b-fp8-vllm-agg-frontend:8000
            - name: AIPERF_VERSION
              value: "0.10.0"
