...
| `qwen3-32b-fp8-vllm-agg-tp2` | Qwen3-32B-FP8 | Working | 8 aggregated workers × TP=2 | 16 GPUs | [`models/qwen3-32B-fp8/vllm/agg-routing/deploy.yaml`](models/qwen3-32B-fp8/vllm/agg-routing/deploy.yaml) |
| `qwen3-32b-fp8-vllm-agg-kv-offload` | Qwen3-32B-FP8 | Working | 8 aggregated workers × TP=2 with host KV tier | 16 GPUs | [`models/qwen3-32B-fp8/vllm/agg-routing-kv-offloading/deploy.yaml`](models/qwen3-32B-fp8/vllm/agg-routing-kv-offloading/deploy.yaml) |
| `qwen3-32b-fp8-vllm-disagg` | Qwen3-32B-FP8 | Working | 6 prefill × TP=2 + 2 decode × TP=2 | 16 GPUs | [`models/qwen3-32B-fp8/vllm/disagg-routing/deploy.yaml`](models/qwen3-32B-fp8/vllm/disagg-routing/deploy.yaml) |
| `qwen3-32b-fp8-vllm-disagg-kv-aware` | Qwen3-32B-FP8 | Working | 6 prefill × TP=2 + 2 decode × TP=2 with KV routing | 16 GPUs | [`models/qwen3-32B-fp8/vllm/disagg-routing-kv-aware/deploy.yaml`](models/qwen3-32B-fp8/vllm/disagg-routing-kv-aware/deploy.yaml) |
...
This is one example for the Qwen3-32B-FP8 aggregated vLLM experiment. Replace the
recipe variables with the values from the selected experiment's README.

```bash
# Setup
export RECIPE_ROOT="$SHARED_ROOT/qwen3-32b-fp8"
